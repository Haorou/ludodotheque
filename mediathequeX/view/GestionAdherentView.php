        ...
        <nav class="nav nav-tabs nav-justified">
            ...
            <a class="nav-item nav-link active" href="#">
    	   		<form action="index.php?action=gestionAdherents" method="post">
    				<button type="submit" class="btn btn-primary btn-block" value="Gestion Adherents" name="gestionAdherents">Gestion Adherents</button>
        		</form>
            </a>
            ...
            <a class="nav-item nav-link" href="#">
           		<form action="index.php?action=gestionAlerte" method="post">
            		<button type="submit" class="btn btn-block" value="Gestion Alerte" name="gestionAlerte">Gestion Alerte </button>
            	</form>
            </a>
