        ...
        <div class="container" style="margin-top: 10px">
            ...
            <div class="row">  <!--Pour afficher les colonnes col-md-6  -->
                ...
                <div class="col-md-6" style="text-align: center">
                    <div class="row">
                        <div class="col-md-6" style="text-align: center">
                            <input type="text" class="form-control" name="nbrejoueurmin" placeholder="Joueurs min" required />
                            <input type="text" class="form-control" name="agemin" placeholder="Age min" required/>  
                            <input type="text" class="form-control" name="dureemin" placeholder="Duree min"  required/>  
                        </div>
                        <div class="col-md-6" style="text-align: center">
							<input type="text" class="form-control" name="nbrejoueurmax" placeholder="Joueurs max" required />
                            <input type="text" class="form-control" name="agemax" placeholder="Age max"  required/>  
                            <input type="text" class="form-control" name="dureemax" placeholder="Duree max"  required/>  
                        </div>
                    </div>
                         <div class="col-md-12" style="text-align: center">
                            <textarea class="form-control" name="descriptif" rows="3" placeholder="Descriptif"></textarea>
                        </div>
                        
                        <button type="submit" class="btn btn-lg btn-success" value="" name="ajouterFicheJeu">
